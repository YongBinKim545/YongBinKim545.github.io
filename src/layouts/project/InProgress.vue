    ...
    <div>
        ...
        <v-card height="67vh" class="mx-2 mt-2" flat>
            <v-toolbar color="transparent">
                <single-h-bar :datasets="datasets" :title="['진행현황']" :height="60" v-show="!searchFocus || !mobile" />
                <v-spacer />
        ...
        <dialog-for-edit title="InProgress Details" v-if="dialogActivate" :initialValue="selectedItem" :activate="dialogActivate" @on-close="closeDialog" />
    </div>
</template>
