<template>
    <v-card flat width="300" height="400" style="overflow-y: scroll;">
        <div class="mx-6 my-4" ref="formContainer">
            <v-form @submit.prevent>
                ...
                <v-autocomplete v-model="signUpFormData.companyName" :items="companyList" @focus="actionFocus"
                    @blur="actionBlur" @keyup.enter="handlingKeyUp" density="compact" variant="outlined" rounded
                    placeholder="검색어를 넣으세요" label="소속회사" class="my-2" id="3">
                    <template v-slot:prepend-item>
